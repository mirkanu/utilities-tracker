...
- [x] **Phase 8: Analytics Page** - New Analytics tab with YoY comparison, projected spend, and refill pattern cards — completed 2026-05-30
...
**Plans**: 3 plans
  - [x] 08-01-PLAN.md — oil-analytics.ts pure computation library + unit tests (TDD)
  - [x] 08-02-PLAN.md — BottomNav 4th tab + /analytics route shell + loading.tsx
