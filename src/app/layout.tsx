...
export default async function RootLayout({
  ...
  // utilities_session is the iron-session encrypted cookie — present only when authenticated
  const isLoggedIn = cookieStore.has("utilities_session");

  return (
    <html lang="en" suppressHydrationWarning>
      <body className={inter.className}>
        {/* Logout button — top-right corner, only shown to authenticated users */}
